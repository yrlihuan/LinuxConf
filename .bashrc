...
if [ "$color_prompt" = yes ]; then
  PS1="${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\] \[\033[0;36m\]\`ruby -e \"print (%x{git branch 2> /dev/null}.split(%Q[\n]).grep(/^\*/).first || '').gsub(/^\* (.+)$/, '(\1) ')\"\`\[\033[37m\]$\[\033[00m\] "
else
...
alias ....='cd ../../..'
alias .....='cd ../../../..'
alias vm='ssh localhost -p 2222 -A'
alias eagle='ssh eagle.hvps.tk -A'
alias mustang='ssh mustang.hvps.tk -A'
alias thunder='ssh thunder -A'
alias tomcat='ssh tomcat -A'
alias vi='vim'
