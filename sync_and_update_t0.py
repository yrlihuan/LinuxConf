...
STRATEGIES_DIR = os.path.join(os.environ['HOME'], 'traders/strategies')
...
def main(args):
  ...
  traders_file = os.path.join(STRATEGIES_DIR, 't0', date_str + '.txt')
  ...
  cmd = "sudo cp %s %s && sudo chown huan:huan %s" % (accounting_file, traders_file, traders_file)
  print cmd
  os.system(cmd)
